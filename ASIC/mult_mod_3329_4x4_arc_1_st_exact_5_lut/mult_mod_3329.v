...
mult_4x4_2_8_strong_5_lut  label3 (.x0(A[4]),.x1(A[3]),.x2(A[2]),.x3(A[1]),
...
mult_3_2_12_exact_5_lut  label12 (.x0(temp_R_1[15]),.x1(temp_R_1[14]),.x2(temp_R_1[13]),
