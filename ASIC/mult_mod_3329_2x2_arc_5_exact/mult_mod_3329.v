...
mult_6x2_01_exact  label1 (.x0(B[2]),.x1(B[1]),
...
mult_6x2_02_exact  label2 (.x0(B[2]),.x1(B[1]),
...
mult_6x2_11_exact  label11 (.x0(B[12]),.x1(B[11]),
          .x2(A[10]),.x3(A[9]),.x4(A[6]),.x5(A[5]),.x6(A[2]),.x7(A[1]),
...
mult_6x2_12_exact  label12 (.x0(B[12]),.x1(B[11]),
          .x2(A[12]),.x3(A[11]),.x4(A[8]),.x5(A[7]),.x6(A[4]),.x7(A[3]),
...
mult_4_2_12_exact label20 (.x0(temp_R_1[16]),.x1(temp_R_1[15]),.x2(temp_R_1[14]),.x3(temp_R_1[13]),
