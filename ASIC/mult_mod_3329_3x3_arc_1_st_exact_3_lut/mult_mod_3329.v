...
mult_3x3_2_9_exact_3_lut  label4 (.x0(A[3]),.x1(A[2]),.x2(A[1]),
...
mult_3x3_2_9_exact_3_lut  label10 (.x0(A[9]),.x1(A[8]),.x2(A[7]),
          .x3(B[6]),.x4(B[5]),.x5(B[4]),
...
mult_3x3_2_12_exact_3_lut  label11 (.x0(A[9]),.x1(A[8]),.x2(A[7]),
          .x3(B[9]),.x4(B[8]),.x5(B[7]),
...
mult_3x3_2_15_exact_3_lut  label12 (.x0(A[9]),.x1(A[8]),.x2(A[7]),
          .x3(B[12]),.x4(B[11]),.x5(B[10]),
...
mult_3x3_2_9_exact_3_lut  label13 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[3]),.x4(B[2]),.x5(B[1]),
...
mult_3x3_2_12_exact_3_lut  label14 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[6]),.x4(B[5]),.x5(B[4]),
...
mult_3x3_2_15_exact_3_lut  label15 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[9]),.x4(B[8]),.x5(B[7]),
...
mult_3x3_2_18_exact_3_lut  label16 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[12]),.x4(B[11]),.x5(B[10]),
...
//mult_3_2_3_exact label17 (.x0(temp_R_1[6]),.x1(temp_R_1[5]),.x2(temp_R_1[4]),
//          .z0(r17[6]),.z1(r17[5]),.z2(r17[4]),.z3(r17[3]),.z4(r17[2]),.z5(r17[1]));

//mult_3_2_6_exact  label18 (.x0(temp_R_1[9]),.x1(temp_R_1[8]),.x2(temp_R_1[7]),
...
mult_3_2_12_exact_3_lut  label20 (.x0(temp_R_1[15]),.x1(temp_R_1[14]),.x2(temp_R_1[13]),
