...
mult_4x4_st  labell (.x0(A[4]),.x1(A[3]),.x2(A[2]),.x3(A[1]),
          .x4(B[4]),.x5(B[3]),.x6(B[2]),.x7(B[1]),
          .z0(r1[8]),.z1(r1[7]),.z2(r1[6]),.z3(r1[5]),.z4(r1[4]),.z5(r1[3]),.z6(r1[2]),.z7(r1[1]));

mult_4x4_2_4_st  label2 (.x0(A[4]),.x1(A[3]),.x2(A[2]),.x3(A[1]),
...
mult_4x4_2_8_strong_3_lut  label3 (.x0(A[4]),.x1(A[3]),.x2(A[2]),.x3(A[1]),
...
mult_3_2_12_exact_3_lut  label12 (.x0(temp_R_1[15]),.x1(temp_R_1[14]),.x2(temp_R_1[13]),
...
assign temp_R_2 = temp_R_1[12:1] + r12;
