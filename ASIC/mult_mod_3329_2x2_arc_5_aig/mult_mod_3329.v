...
mult_6x2_01_aig  label1 (.x0(B[2]),.x1(B[1]),
...
mult_6x2_02_aig  label2 (.x0(B[2]),.x1(B[1]),
...
mult_6x2_11_aig  label11 (.x0(B[12]),.x1(B[11]),
          .x2(A[10]),.x3(A[9]),.x4(A[6]),.x5(A[5]),.x6(A[2]),.x7(A[1]),
...
mult_6x2_12_aig  label12 (.x0(B[12]),.x1(B[11]),
          .x2(A[12]),.x3(A[11]),.x4(A[8]),.x5(A[7]),.x6(A[4]),.x7(A[3]),
