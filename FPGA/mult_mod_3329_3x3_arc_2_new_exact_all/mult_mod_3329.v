...
mult_3x3_2_9_exact  label4 (.x0(A[3]),.x1(A[2]),.x2(A[1]),
...
mult_3x3_2_12_exact  label11 (.x0(A[9]),.x1(A[8]),.x2(A[7]),
          .x3(B[9]),.x4(B[8]),.x5(B[7]),
...
mult_3x3_2_15_exact label12 (.x0(A[9]),.x1(A[8]),.x2(A[7]),
          .x3(B[12]),.x4(B[11]),.x5(B[10]),
...
mult_3x3_2_9_exact  label13 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[3]),.x4(B[2]),.x5(B[1]),
...
mult_3x3_2_12_exact  label14 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[6]),.x4(B[5]),.x5(B[4]),
...
mult_3x3_2_15_exact  label15 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[9]),.x4(B[8]),.x5(B[7]),
...
mult_3x3_2_18_exact  label16 (.x0(A[12]),.x1(A[11]),.x2(A[10]),
          .x3(B[12]),.x4(B[11]),.x5(B[10]),
...
mult_3_2_12_exact  label20 (.x0(temp_R_1[15]),.x1(temp_R_1[14]),.x2(temp_R_1[13]),
...
assign temp_R_2 = temp_R_1[12:1] + r20;
